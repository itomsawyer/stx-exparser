 ...
 * done in the "higher" domain. */
    ...
    public:
        ...
        enum attrtype_t
        {
            ...
            /// Regex String type, variable length. Needs much extra care to handle
            /// memory allocation.
                    ATTRTYPE_REGEX = 0x41
        };
    ...
    private:
        ...
        union value_t
        {
            ...
            /// Used for ATTRTYPE_REGEX, make sure it get delete'ed correctly.
            boost::regex*       _regex;
        };
    ...
    public:
                ...
                : atype(a.atype)
        {
            switch(atype)
            {
                ...
                case ATTRTYPE_STRING:
                    ...
                    break;
                case ATTRTYPE_REGEX:
                    val._regex = new boost::regex(*a.val._regex);
                    break;
            }
        }
        ...
        /// quoted: "str". If regex is true, string will be parsed as regex string
        /// This function resolves escape sequences like \n.
        bool		setStringQuoted(const std::string &s, bool regex = false);
         ...
         * sequences. */
        std::string		getStringQuoted(const char *prefix = "\"", const char *suffix = "\"") const;
