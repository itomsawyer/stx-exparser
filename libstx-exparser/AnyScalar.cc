...
{
    if (atype == ATTRTYPE_STRING && a.atype == ATTRTYPE_REGEX) {
        assert(val._string && a.val._regex);
        return boost::regex_match(val._string->c_str(), *a.val._regex);
    }

    if (a.atype == ATTRTYPE_STRING && atype == ATTRTYPE_REGEX) {
        assert(a.val._string && val._regex);
        return boost::regex_match(a.val._string->c_str(), *val._regex);
    }
    ...
    switch(atype)
    {
        ...
        case ATTRTYPE_REGEX:
            assert(val._regex && a.val._regex);
            return (*val._regex == *a.val._regex);
    }
...
std::string AnyScalar::getTypeString(attrtype_t at)
{
    switch(at)
    {
        ...
        case ATTRTYPE_REGEX:	return "regex";
    }
    return "unknown";
}
...
unsigned int AnyScalar::getValueLength() const
{
    switch(atype)
    {
        ...
        case ATTRTYPE_REGEX:
            assert(val._regex);
            //XXX value size is not the memory binary size, fix later
            return val._regex->size();
    }
...
bool AnyScalar::setInteger(int i)
{
    switch(atype)
    {
        ...
        case ATTRTYPE_REGEX:
            throw(ConversionException("Cannot convert integer to regex."));
    ...
    switch(atype)
    {
        ...
        case ATTRTYPE_STRING:
            ...
            *val._string = boost::lexical_cast<std::string>(l);
            return true;
        case ATTRTYPE_REGEX:
            throw(ConversionException("Cannot convert long to regex."));
    }
...
bool AnyScalar::setStringQuoted(const std::string &s, bool regex) {
    // unescape string
    unsigned int i;
...
bool AnyScalar::getBoolean() const
{
    switch(atype)
    {
        ...
        case ATTRTYPE_REGEX:
            throw(ConversionException("Cannot convert regex to boolean."));
            break;
    }
...
int AnyScalar::getInteger() const
{
    switch(atype)
    {
        ...
        case ATTRTYPE_REGEX:
            throw(ConversionException("Cannot convert regex to integer."));
            break;
    }
...
unsigned int AnyScalar::getUnsignedInteger() const
{
    switch(atype)
    {
        ...
        case ATTRTYPE_REGEX:
            throw(ConversionException("Cannot convert regex to unsigned integer."));
            break;
    }
...
long long AnyScalar::getLong() const
{
    switch(atype)
    {
        ...
        case ATTRTYPE_REGEX:
            throw(ConversionException("Cannot convert regex to long long."));
            break;
    }
...
unsigned long long AnyScalar::getUnsignedLong() const
{
    switch(atype)
    {
        ...
        case ATTRTYPE_REGEX:
            throw(ConversionException("Cannot convert regex to unsigned long long."));
            break;
    }
    assert(0);
    return false;
...
double AnyScalar::getDouble() const
{
    switch(atype)
    {
        ...
        case ATTRTYPE_REGEX:
            throw(ConversionException("Cannot convert regex to double."));
            break;
    }
    assert(0);
    return false;
...
std::string AnyScalar::getStringQuoted(const char *prefix, const char *suffix) const
{
    std::string str = getString();
    std::string os = prefix;
...
void AnyScalar::resetType(attrtype_t t)
{
    ...
    else if (t == ATTRTYPE_REGEX) {
        if (atype != ATTRTYPE_REGEX) {
            val._regex = new boost::regex;
        }
    } else {
        if (atype == ATTRTYPE_STRING) {
            delete val._string;
...
bool AnyScalar::convertType(attrtype_t t)
{
    ...
    // cannot convert regex to any type except for string
    if (atype == ATTRTYPE_REGEX && t != ATTRTYPE_STRING) {
        return false;
    }
    ...
    switch(t)
    {
        ...
        case ATTRTYPE_STRING:
        {
            auto str = new std::string(getString());
            if (atype == ATTRTYPE_REGEX) {
                delete val._regex;
                val._regex = NULL;
            }
        ...
        {
            if (atype == ATTRTYPE_STRING) {
                auto str = new boost::regex(getString());
                delete val._string;
                val._string= NULL;
                val._regex = str;
                atype = t;
...
AnyScalar AnyScalar::operator-() const
{
    ...
    switch(at.atype)
    {
        ...
        case ATTRTYPE_REGEX:
            throw(ConversionException("Cannot convert regex to double for negation."));
    }
    ...
    switch(atype)
    {
        ...
        case ATTRTYPE_INTEGER:
        {
            switch(b.atype)
            {
                ...
                case ATTRTYPE_REGEX:
                {
                    throw(ConversionException(std::string("Could not convert regex to integer for binary operator ")+OpName+"."));
                }
            }
            break;
        }
        ...
        case ATTRTYPE_DWORD:
        {
            switch(b.atype)
            {
                ...
                case ATTRTYPE_REGEX:
                {
                    throw(ConversionException(std::string("Could not convert regex to unsigned integer for binary operator ")+OpName+"."));
                }
            }
            break;
        }
        ...
        case ATTRTYPE_LONG:
        {
            switch(b.atype)
            {
                ...
                case ATTRTYPE_REGEX:
                {
                    throw(ConversionException(std::string("Could not convert regex to long for binary operator ")+OpName+"."));
                }
            }
            break;
        }
        ...
        case ATTRTYPE_QWORD:
        {
            switch(b.atype)
            {
                ...
                case ATTRTYPE_REGEX:
                {
                    throw(ConversionException(std::string("Could not convert regex to unsigned long long for binary operator ")+OpName+"."));
                }
            }
            break;
        }
        ...
        case ATTRTYPE_FLOAT:
        {
            switch(b.atype)
            {
                ...
                case ATTRTYPE_REGEX:
                {
                    throw(ConversionException(std::string("Could not convert regex to float for binary operator ")+OpName+"."));
                }
            }
        ...
        case ATTRTYPE_DOUBLE:
        {
            switch(b.atype)
            {
                ...
                case ATTRTYPE_REGEX:
                {
                    throw(ConversionException(std::string("Could not convert regex to double for binary operator ")+OpName+"."));
                }
            }
        ...
        case ATTRTYPE_STRING:
        {
            switch(b.atype)
            {
                ...
                case ATTRTYPE_REGEX:
                {
                    throw(ConversionException(std::string("Binary operator ")+OpName+" is not allowed with right regex values."));
                }
            }
            break;
        }
        case ATTRTYPE_REGEX:
        {
            throw(ConversionException(std::string("Binary operator ")+OpName+" is not allowed with left regex values."));
        }
    }
    assert(0);
    ...
    switch(atype)
    {
        ...
        case ATTRTYPE_INTEGER:
        {
            switch(b.atype)
            {
                ...
                case ATTRTYPE_REGEX:
                {
                    throw(ConversionException(std::string("Could not convert regex to integer for binary operator ")+OpNameArray[OpNum]+"."));
                }
            }
            break;
        }
        ...
        case ATTRTYPE_DWORD:
        {
            switch(b.atype)
            {
                ...
                case ATTRTYPE_REGEX:
                {
                    throw(ConversionException(std::string("Could not convert regex to unsigned integer for binary operator ")+OpNameArray[OpNum]+"."));
                }
            }
            break;
        }
        ...
        case ATTRTYPE_LONG:
        {
            switch(b.atype)
            {
                ...
                case ATTRTYPE_REGEX:
                {
                    throw(ConversionException(std::string("Could not convert regex to long long for binary operator ")+OpNameArray[OpNum]+"."));
                }
            }
            break;
        }
        ...
        case ATTRTYPE_QWORD:
        {
            switch(b.atype)
            {
                ...
                case ATTRTYPE_REGEX:
                {
                    throw(ConversionException(std::string("Could not convert regex to unsigned long long for binary operator ")+OpNameArray[OpNum]+"."));
                }
            }
            break;
        }
        ...
        case ATTRTYPE_FLOAT:
        {
            switch(b.atype)
            {
                ...
                case ATTRTYPE_REGEX:
                {
                    throw(ConversionException(std::string("Could not convert regex to float for binary operator ")+OpNameArray[OpNum]+"."));
                }
            }
        ...
        case ATTRTYPE_DOUBLE:
        {
            switch(b.atype)
            {
                ...
                case ATTRTYPE_REGEX:
                {
                    throw(ConversionException(std::string("Could not convert regex to double for binary operator ")+OpNameArray[OpNum]+"."));
                }
            }
        ...
        case ATTRTYPE_STRING:
        {
            switch(b.atype)
            {
                ...
                {
                    if (OpNum == 0 ) {
                        return regex_match(*val._string, *b.val._regex);
                    }
                    ...
                    throw(ConversionException(std::string("Could not use string and regex value for binary operator ")+OpNameArray[OpNum]+"."));
                }
            }
            break;
        }
        ...
        case ATTRTYPE_REGEX:
        {
            switch(b.atype)
            {
                ...
                {
                    if (OpNum == 0 ) {
                        return regex_match(*b.val._string, *val._regex);
                    }
                    ...
                    throw(ConversionException(std::string("Could not use regex and string value for binary operator ")+OpNameArray[OpNum]+"."));
                }

                default:
                    throw(ConversionException(std::string("Binary operator ")+OpNameArray[OpNum]+" is not permitted on regex values."));
            }
        }
